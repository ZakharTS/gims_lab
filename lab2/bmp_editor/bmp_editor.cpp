...
int main() {
    int constLimit = 15;
    // исходное
    string path = "C:\\Users\\admin\\Desktop\\Example_source\\SimpleBitmap\\Astronaut.bmp";
    openImage(path);
    showImage(path);
    imgToBrightness();
    contrastRoberts();
    limit(constLimit);
    path = "C:\\Users\\admin\\Desktop\\Example_source\\SimpleBitmap\\AstronautContrast.bmp";
    saveImage(path);
    showImage(path);

    // исходное плюс фильтр
    path = "C:\\Users\\admin\\Desktop\\Example_source\\SimpleBitmap\\Astronaut.bmp";
    openImage(path);
    showImage(path);
    // фильтр
    filter(readCenterX(), readCenterY(), readLimit()); // выбор центра окна, окно 3 на 3 (крестообразное)
    path = "C:\\Users\\admin\\Desktop\\Example_source\\SimpleBitmap\\AstronautFilter.bmp";
    saveImage(path);
    showImage(path);
    ...
    contrastRoberts();
    limit(constLimit);
    path = "C:\\Users\\admin\\Desktop\\Example_source\\SimpleBitmap\\AstronautFilterContrast.bmp";
    saveImage(path);
    showImage(path);
    ...
    path = "C:\\Users\\admin\\Desktop\\Example_source\\SimpleBitmap\\AstronautNoise.bmp";
    saveImage(path);
    showImage(path);
    ...
    contrastRoberts();
    limit(constLimit);
    path = "C:\\Users\\admin\\Desktop\\Example_source\\SimpleBitmap\\AstronautNoiseContrast.bmp";
    saveImage(path);
    showImage(path);
    ...
    path = "C:\\Users\\admin\\Desktop\\Example_source\\SimpleBitmap\\AstronautNoiseFilter.bmp";
    saveImage(path);
    showImage(path);
    ...
    contrastRoberts();
    limit(constLimit);
    path = "C:\\Users\\admin\\Desktop\\Example_source\\SimpleBitmap\\AstronautNoiseFilterContrast.bmp";
    saveImage(path);
    showImage(path);
